    ...
    <section className="booking-section">
      <div className="container">
        <div className="booking">
          <h2 className="booking__title title">Book a free test lesson</h2>
          <p className="booking__text text">
            The objective of the call is to have a quick meet-and-greet, assess compatibility, and talk about backgrounds, motivations, what to expect moving forward and experience a first free lesson without any commitment.
          </p>
