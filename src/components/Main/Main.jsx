        ...
        <div className="container">
          <div className="slide">
            ...
            <p className="slide__text text">
              Learn how to trade stocks with confidence through a structured process designed to deliver results. The
              4-week high-impact program is offered at $10,000 with limited availability.
            </p>
